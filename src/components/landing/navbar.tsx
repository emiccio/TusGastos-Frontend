    ...
    <nav className="fixed top-0 left-0 right-0 z-50 bg-[#09090b]/80 backdrop-blur-md border-b border-white/5 py-4 transition-all duration-300">
      <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-8">
          <Link href="#caracteristicas" className="text-sm font-medium text-zinc-400 hover:text-white transition-colors">
            Características
          </Link>
        ...
        <div className="flex items-center gap-4">
          <Link href="/login" className="hidden sm:block text-sm font-medium text-zinc-400 hover:text-white transition-colors px-4">
            Ingresar
          </Link>
          <Button asChild className="bg-white text-black hover:bg-zinc-200 rounded-full font-bold shadow-sm">
