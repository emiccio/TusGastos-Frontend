      ...
      <main className="flex-1 py-20">
        <div className="max-w-3xl mx-auto px-6 bg-white p-10 rounded-3xl shadow-sm border border-gray-100">
          ...
          <div className="space-y-6 text-gray-700">
            <p>Al utilizar TusGastos, aceptas estos términos de servicio en su totalidad.</p>
            
            <h2 className="text-xl font-semibold mt-8 mb-4">1. Uso del servicio</h2>
            <p>TusGastos es una herramienta de asistencia financiera personal. El servicio se provee "tal cual" sin garantías explícitas o implícitas de ningún tipo.</p>
            ...
            <p>TusGastos no es un asesor financiero. La información provista por la plataforma es únicamente a título informativo. No nos hacemos responsables por decisiones financieras tomadas basadas en dicha información.</p>
          </div>
        </div>
      </main>
      <Footer />
